...
// Regression guard, Aug 9 2026: the homepage and About page must accurately
// present BOTH Bible Reading Plan paces — 1 Year · 52 Weeks and
// 2 Years · 104 Weeks. Neither surface may claim only the 52-week plan
// exists (the pre-104-week copy this replaces did exactly that).
